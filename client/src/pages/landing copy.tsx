        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="card-shadow hover-lift">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Control multiple displays from a centralized dashboard with
          ...
          <Card className="card-shadow hover-lift">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Get intelligent content recommendations based on audience, time,
                and engagement data.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="card-shadow hover-lift">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Role-based access control with audit logging for team workflows
          ...
          <Card className="card-shadow hover-lift">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Track performance metrics and optimize content delivery with
                detailed insights.
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        <Card className="max-w-4xl mx-auto card-shadow">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl mb-4">
              Experience the Power of AI-Driven Digital Signage
            </CardTitle>
            <CardDescription className="text-lg">
              Streamline your content workflow with intelligent automation and
              real-time updates.
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI automatically tags uploaded images and videos for easy
                      organization.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Optimize content timing based on audience patterns and
                      engagement data.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Push content changes instantly to connected displays via
                      WebSocket.
                    </p>
                  </div>
                </div>
